...
import flower from "../Assets/garden.jpeg"

const GardenServicesProducts = () => {
  return (
    <div name="/garden" className='h-full w-screen flex flex-col justify-center pt-20 py-10 px-10 '>
            <h1 className='text-3xl sm:text-4xl font-bold text-black px-5 py-2 '>Home Garden  </h1>
            <div className=' flex flex-wrap items-center gap-4'>
                <div name="/event" className=' lg:w-1/4 p-5  shadow-[rgba(_0,_0,_0,0.24)_12px_13px_10px] rounded-lg flex flex-col justify-center items-center'>
                    ...
                    <div className='space-y-5'>
                        <h3 className=' text-xl text-center pt-6 font-semibold'>Garden Flower</h3>
...
export default GardenServicesProducts